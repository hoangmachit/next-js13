    ...
    <>
      <div className="container-xxl flex-grow-1 container-p-y">
        <h4 className="fw-bold py-3 mb-4">
          <span className="text-muted fw-light">Users /</span> Detail
        </h4>
        <div className="row">
                  ...
                  <div className="row">
                    ...
                    <div className="mb-3 col-md-6">
                      ...
                      <select id="timeZones" className="select2 form-select">
                        ...
                        <option defaultValue="-10">(GMT-10:00) Hawaii</option>
                        <option defaultValue="-9">(GMT-09:00) Alaska</option>
                        ...
                        <option defaultValue="-7">(GMT-07:00) Arizona</option>
