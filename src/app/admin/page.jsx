                ...
                <div className="card">
                  <div className="card-body">
                    <div className="card-title d-flex align-items-start justify-content-between">
                      <div className="avatar flex-shrink-0">
                        <img
                          src="/assets/admin/img/icons/unicons/cc-primary.png"
                          alt="Credit Card"
                          className="rounded"
                        />
                      </div>
              ...
              <div className="card-body">
                <ul className="p-0 m-0">
                  ...
                  <li className="d-flex mb-4 pb-1">
                    <div className="avatar flex-shrink-0 me-3">
                      <img
                        src="/assets/admin/img/icons/unicons/chart.png"
                        alt="User"
                        className="rounded"
                      />
                    </div>
                  ...
                  <li className="d-flex mb-4 pb-1">
                    <div className="avatar flex-shrink-0 me-3">
                      <img
                        src="/assets/admin/img/icons/unicons/cc-success.png"
                        alt="User"
                        className="rounded"
                      />
                    </div>
                  ...
                  <li className="d-flex">
                    <div className="avatar flex-shrink-0 me-3">
                      <img
                        src="/assets/admin/img/icons/unicons/cc-warning.png"
                        alt="User"
                        className="rounded"
                      />
                    </div>
